#Por Heloísa Martins Vieira - Junho/2022

Um pequeno projeto usando HTML, CSS e Js para exibição aos estagiários do Projeto Escola de Desenvolvedores 2022, da empresa Nota Control. O projeto não tem finalidade a não ser a exibição de uma breve mensagem motivacional e a apresentação de animações básicas que podem ser realizadas em uma página web, com recursos iniciais destas ferramentas.
